    ...
    <main className="app-shell min-h-screen bg-white pb-32 text-[#202024]">
      ...
      <div className="px-5">
        ...
        <div className="flex items-center justify-between mt-2">
          <div>
            <h1 className="text-[22px] font-black text-[#232129]">CryptoMagic님</h1>
            <p className="text-[13px] text-[#4f4a5f] mt-0.5">오늘도 멋진 밋업을 기대할게요</p>
          </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-[#7446D8] px-5 py-5 text-white mt-5 shadow-[0_12px_24px_rgba(116,70,216,0.25)]">
          ...
          <div className="relative">
            <p className="text-[13px] font-semibold text-white/90">내 지갑 잔액</p>
        ...
        <div className="mt-7">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-[15px] font-black text-[#232129]">내 밋업 관리</h2>
            <Link href="/meetups" className="text-[12px] font-semibold text-[#7B5CF6]">전체보기 →</Link>
          </div>
          <div className="flex flex-col items-center justify-center rounded-2xl border border-[#D9D1EA] bg-[#FBFAFF] px-8 py-10 text-center">
            ...
            <p className="text-[14px] font-black text-[#232129]">아직 개최한 밋업이 없어요</p>
            <p className="mt-2 text-[12px] font-medium leading-relaxed text-[#656070]">
              다양한 국가의 친구들과 함께하는 밋업을 직접 만들어보세요!
            </p>
            <Link
              href="/meetups/create"
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          <div className="rounded-2xl bg-[#F4F0FF] border border-[#E6DAFF] p-4">
            ...
            <p className="text-[11px] text-[#656070] font-medium">호스트 등급</p>
            <p className="text-[14px] font-black text-[#232129] mt-0.5">실버 파트너</p>
          </div>
          <div className="rounded-2xl bg-[#F4F0FF] border border-[#E6DAFF] p-4">
            <MessageSquare size={18} className="text-[#7B5CF6] mb-2" />
            <p className="text-[11px] text-[#656070] font-medium">읽지 않은 메시지</p>
            <p className="text-[14px] font-black text-[#232129] mt-0.5">0 개</p>
          </div>
        </div>
        ...
        <div className="mt-5 relative overflow-hidden rounded-2xl bg-[#1a1a2e] px-6 py-5 mb-5">
          <div className="absolute inset-0 opacity-40"
            style={{ background: 'linear-gradient(135deg, #6F3FD7, #1a1a2e)' }} />
          <div className="relative">
            <p className="text-[11px] font-semibold text-white/70">인기 있는 호스트가 되는 팁</p>
            <p className="text-[16px] font-black text-white mt-1 leading-snug">신뢰도 높은<br />프로필 만들기</p>
          </div>
        </div>
      </div>
